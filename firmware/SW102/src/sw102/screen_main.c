...
DEFINE_FONT(2nd, "./0123456789Wehikmnr", 3, 11, 18, 22, 29, 36, 44, 51, 58, 65, 72, 79, 90, 96, 102, 105, 111, 120, 126);
	  ...
	  //if(ui->ui8_error_states & 1)
	   ...
	   //   showScreen(&screen_boot);
	    ...
	    else if(ui->ui8_error_states & 32)
	    {
	      ...
	      e1 = "err07";
	    else if(ui->ui8_error_states & 128 || ui_vars.ui8_speed_sensor_err)
	      e1 = "err08";
	    else
	      return false;
	  if(!(display_mode == ModeBigScreen))
